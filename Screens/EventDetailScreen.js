            ...
            return(
                <Container>
                    ...
                    <Content style={{backgroundColor: 'white'}}>
                        <Image source={icon} style={{ backgroundColor: 'transparent', opacity: 0.8, height: 2*deviceHeight/7}} resizeMode="stretch">
                                ...
                                <FlatList
                                    ...
                                    renderItem={ 
                                        ({item}) => {
                                            return(
                                                 <ListItem>
                                                <Text style={{fontFamily: theme.fontFamily}}>{item.startTime} - {item.endTime}  -   {item.description}</Text>
                                                 </ListItem>
                                            );
