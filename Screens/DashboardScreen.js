...
export default class DashboardScreen extends Component {
	...
	buttonHandler(){
		console.log('Notofications pressed');
	}
	closeCarousel(){
			...
			<View style={{flex: 1, flexDirection: 'column'}}>
				...
				<View style={{flex: 5, flexDirection: 'row', justifyContent: 'center', backgroundColor: '#ecf2f4', paddingLeft: 20, paddingRight: 20}} zIndex={-1}>
					<View style={{flexDirection:'column', justifyContent:'flex-start', backgroundColor:'#ecf2f4', padding: 10}}>
						{/* tile */}
						<TouchableOpacity onPress={()=>this.props.navigator.navigate('Deals')}>
							<View style={[styles.tile, {alignItems: 'center'}]}>
								<View style={{alignSelf: 'flex-end'}}>
									<Text style={styles.notification}>2</Text>
								</View>
								
								<Icon name='buffer' android='logo-buffer' ios='logo-buffer' style={{fontSize: 40, color: '#4a4a4a', marginTop: 10, marginBottom: 10}}/> 
								<Text style={{fontSize: 15, color:'#4a4a4a', marginTop: 10, fontFamily: theme.fontFamily, fontWeight: 'bold'}}>Deals</Text>
