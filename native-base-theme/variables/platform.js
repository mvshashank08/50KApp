...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === "ios" ? "white" : "white",

  // FooterTab
  tabBarTextColor: platform === "ios" ? "#b5b6b7" : "#b5b6b7",
  tabBarTextSize: platform === "ios" ? 14 : 11,
  activeTab: platform === "ios" ? "#007aff" : "#fff",
  sTabBarActiveTextColor: "#007aff",
  tabBarActiveTextColor: platform === "ios" ? "#2a91f6" : "#2a91f6",
  tabActiveBgColor: platform === "ios" ? undefined : undefined,
  ...
  toolbarDefaultBg: platform === "ios" ? "#2a91f6" : "#2a91f6",
  ...
  toolbarTextColor: platform === "ios" ? "white" : "white",
